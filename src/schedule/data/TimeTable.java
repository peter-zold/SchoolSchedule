...
public class TimeTable {
    public static Lesson[] createRandomTimeTable(Classes classes) {
        ...
        int[] siteOfFreePeriod = siteOfHoleInTimeTable(classes);
        Lesson[] classLessons = lessonsInTimeTable(clonedLessons, siteOfFreePeriod);

        //Tesztelés
        printTimeTable(classLessons, siteOfFreePeriod);
        return classLessons;
    }

    private static void printTimeTable(Lesson[] classLessons, int[] siteOfFreePeriod) {
        // Tesztelés
        System.out.println();
