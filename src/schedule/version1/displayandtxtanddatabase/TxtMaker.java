...
public class TxtMaker {
    ...
    public void timetableTxtMaker() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("src\\schedule\\version1\\displayandtxtanddatabase\\timetable.txt"))) {
    ...
    public void subjectNamesTxtMaker() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("src\\schedule\\version1\\displayandtxtanddatabase\\all_the_subjects_in_the_timetable.txt"))) {
    ...
    public void teacherNamesTxtMaker() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("src\\schedule\\version1\\displayandtxtanddatabase\\all_the_teacher_names_in_the_timetable.txt"))) {
    ...
    public void valueOfFreenessTxtMaker() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("src\\schedule\\version1\\displayandtxtanddatabase\\all_the_valueoffreeness_values_in_the_timetable.txt"))) {
